...
void resolve(std::string line, int &total, bool debug)
{
	...
	if (debug == true)
	{
		...
		std::cout << gameId;
		std::cout << "\033[0m, maxRed = \033[0;34m";
		std::cout << maxRed;
		std::cout << "\033[0m, maxGreen = \033[0;34m";
		std::cout << maxGreen;
		std::cout << "\033[0m, maxBlue = \033[0;34m";
		std::cout << maxBlue;
...
int main(int argc, char const *argv[])
{
	...
	std::cout << "The sum of all the IDs of possible game is : \033[1;33m";
	std::cout << total;
	std::cout << "\033[0m" << std::endl;
	return (0);
}